...
5. **Start/restart the server**: `pkill -f "node src/server.js" 2>/dev/null; sleep 1; PORT=3001 node src/server.js &`
6. **Run the test script**: `bash tests/test-0N.sh 3001`
